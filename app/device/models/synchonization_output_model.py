...
class SyncOutput:
    """
    A model class for managing and storing synchronization output data between Netbox and Zabbix systems.
    ...
    Attributes:
        synchronization_output_differences (list[str]): List of differences found during synchronization.
        synchronization_output_netbox (list[str]): List of outputs from Netbox operations.
        synchronization_output_zabbix (list[str]): List of outputs from Zabbix operations.
    Methods:
        add_difference_output(difference: str): Appends a difference message to the differences list.
        add_netbox_output(output: str): Appends a Netbox output message to the Netbox outputs list.
        add_zabbix_output(output: str): Appends a Zabbix output message to the Zabbix outputs list.
